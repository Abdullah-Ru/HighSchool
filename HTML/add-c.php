                                        ...
                                        <div class="con2">
                                            <form method="post" class="form">
                                                ...
                                                <input placeholder="الساعات التطوعية للفرصة" class="input2" name="count_c" type="number"
                                                    ...
                                                    <select id="options"  style="position: relative; right: 70px; top: 90px;">
                                                    <option>عام</option>
                                                    <option>أداري</option>
                            ...
                            <div class="tab-pane fade" id="account-info">
                                <div class="card-body pb-2">
                                    ...
                                    <div style="position: relative; right: 600px; bottom: 200px;;">
                                                    <button id="outline_btn" type="submit" name='Search2' class="butn btn-outline btn-lg"
                                    ...
                                    if (isset($_POST['Search2'])) {
                                        ...
                                        if (mysqli_num_rows($result7) > 0) {
                                            while ($row = mysqli_fetch_assoc($result7)) {
                                                ...
                                                echo '
                                                <div class="card h-100 ml-auto">
                                                <div class="card-body">
                                                <form method="post" class="form2 justify-content-center" id="f_' . $uniqueId . '">
